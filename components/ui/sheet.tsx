...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, title = "Sheet panel", showCloseButton = true, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    ...
    >
      ...
      {children}
      {showCloseButton && (
        <SheetClose className="absolute right-4 top-4 text-zinc-500 hover:text-foreground">
          <X className="h-5 w-5" />
